...
pub(crate) struct ApiProxyStatus {
    ...
    pub(crate) sequence_account_id: Option<String>,
    pub(crate) sequence_account_label: Option<String>,
    pub(crate) thread_bindings: Vec<ApiProxyThreadBindingStatus>,
    pub(crate) last_error: Option<String>,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub(crate) enum ApiProxyThreadBindingSource {
    Auto,
    Manual,
}
...
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ApiProxyThreadBindingStatus {
    pub(crate) session_id: String,
    pub(crate) account_entry_id: String,
    pub(crate) account_label: String,
    pub(crate) source: ApiProxyThreadBindingSource,
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq, Default)]
pub(crate) enum ApiProxyRoutingMode {
    #[serde(rename = "sticky", alias = "followCurrent")]
    Sticky,
    #[serde(rename = "sequential", alias = "fixed")]
    Sequential,
    #[default]
    #[serde(rename = "hybrid", alias = "smart")]
    Hybrid,
}
...
pub(crate) struct AppSettings {
    ...
    pub(crate) api_proxy_port: u16,
    #[serde(default)]
    pub(crate) api_proxy_routing_mode: ApiProxyRoutingMode,
    #[serde(default)]
    pub(crate) api_proxy_account_pool: Option<Vec<String>>,
    #[serde(default)]
    pub(crate) api_proxy_fixed_account_id: Option<String>,
    #[serde(default)]
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            api_proxy_routing_mode: ApiProxyRoutingMode::default(),
            api_proxy_account_pool: None,
            api_proxy_fixed_account_id: None,
...
pub(crate) struct AppSettingsPatch {
    ...
    pub(crate) api_proxy_routing_mode: Option<ApiProxyRoutingMode>,
    pub(crate) api_proxy_account_pool: Option<Option<Vec<String>>>,
    pub(crate) api_proxy_fixed_account_id: Option<Option<String>>,
