...
#[derive(Debug, Clone)]
pub(crate) struct ApiProxyThreadBinding {
...
#[derive(Debug, Clone)]
pub(crate) struct ApiProxyCooldownEntry {
...
pub(crate) struct ApiProxyRuntimeState {
    ...
    pub(crate) thread_bindings: HashMap<String, ApiProxyThreadBinding>,
    pub(crate) model_cooldowns: HashMap<String, ApiProxyCooldownEntry>,
...
pub(crate) struct ApiProxyRuntimeHandle {
    ...
    pub(crate) shared: Arc<Mutex<ApiProxyRuntimeState>>,
}
