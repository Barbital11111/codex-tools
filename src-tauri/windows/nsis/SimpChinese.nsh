...
LangString dontUninstall ${LANG_SIMPCHINESE} "直接安装（不先卸载）"
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "直接安装（此安装包不允许在不卸载的情况下执行降级安装）"
...
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装 ${PRODUCTNAME} 的一个$R4版本。建议先卸载当前版本再继续安装。请选择要执行的操作，然后点击“下一步”继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装包已禁用降级安装，无法继续静默安装，请改用图形安装界面。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "安装 WebView2 失败。应用无法在缺少它的情况下运行，请尝试重新启动安装程序。"
