...
- `<repo-root>/src/components/ApiProxyPanel.tsx`
- `<repo-root>/src/hooks/useCodexController.ts`
...
- `<repo-root>/src-tauri/src/lib.rs`
...
- `<repo-root>/src-tauri/src/state.rs`
...
- `<repo-root>/src-tauri/src/proxy_service.rs`
...
- `<repo-root>/src-tauri/src/models.rs`
...
- 前端控制器：
  - `<repo-root>/src/hooks/useCodexController.ts`
- 调试脚本：
  - `<repo-root>/scripts/test-codex-login-proxy.mjs`
